...
for(int i=0;i<=n;++i){
  ...
  guide[][] px=contour(Tx(f,c),(a,a),(b,b),new real[]{0},12);
  guide[][] py=contour(Ty(f,c),(a,a),(b,b),new real[]{0},12);
  guide[][] pz=contour(Tz(f,c),(a,a),(b,b),new real[]{0},12);
  for(guide p : px[0])
...
surface sf=surface(contour3(f,(a,a,a),(b,b,b),12));
